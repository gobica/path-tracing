  ...
  public static class Samplers
  {
    public static Vector3 UniformSampleSphere()
    {
            ...
            */
            ...
            double z = 2 * ThreadSafeRandom.NextDouble() - 1;
            var theta = 2 * Math.PI * ThreadSafeRandom.NextDouble() - Math.PI;
            double x = Math.Sin(theta) * Math.Sqrt(1 - z * z);
            double y = Math.Cos(theta) * Math.Sqrt(1 - z * z);

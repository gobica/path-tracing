    ...
    public static Scene CornellBox()
    {
      ...
      s.Elements.Add(el);
       ...
       // s.Elements.Add(new DiffuseAreaLight(new Disk(80, 0.1, Transform.Translate(278, 548, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20));
        ...
        // Sphare light 
        // set side of light emmision with "outside" or "inside"
        s.Elements.Add(new DiffuseAreaLight(new Sphere(60, Transform.Translate(278, 500, 280), "outside"), Spectrum.Create(1), 20));

        //s.Elements.Add(new DiffuseAreaLight(new Sphere(60, Transform.Translate(278, 500, 280)), Spectrum.Create(1), 15));

        //Green Sphare - Oren-Nayar material
        el = new Sphere(70, Transform.Translate(250, 70, 120));
        el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Green), 0.3));
        s.Elements.Add(el);


        //Blue  Sphare - Lambetrian
        el = new Sphere(100, Transform.Translate(150, 100, 420));
        el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Blue)));
        s.Elements.Add(el);

         //yellow sphare - Lambetrian
